...
func (e Endpoints) Register(ctx context.Context, in *pb.RegisterReq) (*pb.RegisterRsp, error) {
	response, err := e.RegisterEndpoint(ctx, in)
	if err != nil {
		return nil, err
	}
	return response.(*pb.RegisterRsp), nil
}
...
func MakeRegisterEndpoint(s pb.UsersServer) endpoint.Endpoint {
