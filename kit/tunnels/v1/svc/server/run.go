...
import (
	...
	// This Service
	"github.com/ranxx/proxy/kit/tunnels/v1/handlers"
...
func NewEndpoints(service pb.TunnelsServer) svc.Endpoints {
	// Business domain.
	...
	// Endpoint domain.
	var (
		listtunnelEndpoint = svc.MakeListTunnelEndpoint(service)
		addtunnelEndpoint  = svc.MakeAddTunnelEndpoint(service)
	)
...
func Run(cfg svc.Config) {
	...
	go func() {
		...
		s := grpc.NewServer()
		pb.RegisterTunnelsServer(s, srv)
