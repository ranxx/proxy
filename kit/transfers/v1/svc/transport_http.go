...
func MakeHTTPHandler(endpoints Endpoints, responseEncoder httptransport.EncodeResponseFunc, options ...httptransport.ServerOption) http.Handler {
	...
	m.Methods("GET").Path("/transfer").Handler(httptransport.NewServer(
		endpoints.ListTransferEndpoint,
		DecodeHTTPListTransferZeroRequest,
		responseEncoder,
		serverOptions...,
	))

	m.Methods("POST").Path("/transfer").Handler(httptransport.NewServer(
		endpoints.AddTransferEndpoint,
		DecodeHTTPAddTransferZeroRequest,
		responseEncoder,
		serverOptions...,
	))
	return m
...
// DecodeHTTPListTransferZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded listtransfer request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPListTransferZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	defer r.Body.Close()
	var req pb.ListTransferReq
...
// DecodeHTTPAddTransferZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded addtransfer request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPAddTransferZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	defer r.Body.Close()
	var req pb.AddTransferReq
	buf, err := ioutil.ReadAll(r.Body)
	if err != nil {
		return nil, errors.Wrapf(err, "cannot read body of http request")
	}
