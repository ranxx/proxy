...
import (
	...
	// This Service
	"github.com/ranxx/proxy/kit/transfers/v1/handlers"
...
func NewEndpoints(service pb.TransfersServer) svc.Endpoints {
	// Business domain.
	...
	// Endpoint domain.
	var (
		listtransferEndpoint = svc.MakeListTransferEndpoint(service)
		addtransferEndpoint  = svc.MakeAddTransferEndpoint(service)
	)
...
func Run(cfg svc.Config) {
	...
	go func() {
		...
		s := grpc.NewServer()
		pb.RegisterTransfersServer(s, srv)
