...
func MakeHTTPHandler(endpoints Endpoints, responseEncoder httptransport.EncodeResponseFunc, options ...httptransport.ServerOption) http.Handler {
	...
	m.Methods("GET").Path("/client").Handler(httptransport.NewServer(
		endpoints.ListClientEndpoint,
		DecodeHTTPListClientZeroRequest,
		responseEncoder,
		serverOptions...,
	))
	return m
...
// DecodeHTTPListClientZeroRequest is a transport/http.DecodeRequestFunc that
// decodes a JSON-encoded listclient request from the HTTP request
// body. Primarily useful in a server.
func DecodeHTTPListClientZeroRequest(_ context.Context, r *http.Request) (interface{}, error) {
	defer r.Body.Close()
	var req pb.ListClientReq
